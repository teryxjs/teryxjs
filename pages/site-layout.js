 ...
 *
 * data-page values: home, widgets, explorer, docs, pricing, blog
 */
(function () {
  'use strict';
  ...
  var ICON_MENU = '<svg class="icon-menu" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>';
  var ICON_CLOSE = '<svg class="icon-close" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>';
  ...
  function createNav(currentPage) {
    ...
    var links = [
      ...
      { href: base + 'pricing/', label: 'Pricing', page: 'pricing' },
    ];
  ...
  function createFooter() {
    ...
    footer.innerHTML =
      ...
      '<div class="site-footer-bottom">' +
        '<span>&copy; ' + new Date().getFullYear() + ' Teryx. MIT Licensed.</span>' +
        '<div class="site-footer-social">' +
          '<a href="' + GITHUB_URL + '" target="_blank" rel="noopener" aria-label="GitHub">' + ICON_GITHUB + '</a>' +
        '</div>' +
      '</div>';
